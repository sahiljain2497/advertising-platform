...
def feedback(ad_request_id):
  ...
  #print(user_action, expenditure)
  #print(campaign['campaign_id'], campaign['budget'], campaign['current_slot_budget'])
  #print(campaign['campaign_id'], new_budget, new_current_slot_budget)
